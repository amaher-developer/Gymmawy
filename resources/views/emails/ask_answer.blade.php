...
<div class="mail-main">
    <div class="container">
        <div class="mail-description" @if($lang=='ar') style="direction: rtl; text-align: right" @endif>
            ...
            <h5>{{trans('global.ask_answer_add')}}. </h5>
            <h5><b>{{$ask_inputs['answer']}}. </b></h5>
            <p>{{trans('global.show_answer_question')}}:<br/><a href="{{route('ask', [$question->id, $question->slug])}}" target="_blank">{{route('ask', [$question->id, $question->slug])}}</a></p>
            <br/>
