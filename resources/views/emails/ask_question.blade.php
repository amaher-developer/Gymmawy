...
<div class="mail-main">
    <div class="container">
        <div class="mail-description" @if($lang=='ar') style="direction: rtl; text-align: right" @endif>
            ...
            <h5>{{trans('global.ask_question_add')}}. </h5>
            <h5><b>{{$question->question}}. </b></h5>
            <p>{{$question->details}}. </p><br/>
            <p>{{trans('global.edit_ask_question')}}:<br/><a href="{{route('editQuestionAsk', $question->token)}}" target="_blank">{{route('editQuestionAsk', $question->token)}}</a></p>
            <br/>
