...
<div class="mail-main">
    <div class="container">
        <div class="mail-description" @if($lang=='ar') style="direction: rtl; text-align: right" @endif>
            ...
            <h5>{{trans('global.ask_question_edit')}}. </h5>
            <h5><b>{{$question->question}}. </b></h5>
            <p>{{$question->details}}. </p><br/>
            <p>{{trans('global.your_question')}}:<br/><a href="{{route('ask', [$question->id, $question->slug])}}" target="_blank">{{route('ask', [$question->id, $question->slug])}}</a></p>
            <br/>
