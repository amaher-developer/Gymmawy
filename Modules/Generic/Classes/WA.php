...
//        ]);
    ...
    public function sendTextWithTemplate($phoneNumber, $template, $data, $country_code_check = true): string
    {
//        if(substr($phoneNumber, 0, 2) == "01") $phone = $this->str_replace_first("01", "201", $phoneNumber);
//        elseif(substr($phoneNumber, 0, 2) == "05") $phone = $this->str_replace_first("05", "9665", $phoneNumber);
//        else $phone = $phoneNumber;
...
//        ]);
    ...
    public function sendTextImageWithTemplate($phoneNumber, $template, $data, $image_url, $country_code_check = true): string
    {
