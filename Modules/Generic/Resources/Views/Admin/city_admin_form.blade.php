...
@section('page_body')
    ...
    <div class="col-md-9">
        <input id="name_ar" value="{{ old('name_ar', $city->name_ar) }}"
    ...
    <div class="col-md-9">
        <input id="name_en" value="{{ old('name_en', $city->name_en) }}"
    ...
    <div class="form-group col-md-6" style="clear:both;">
        ...
        <div class="col-md-9">
         ...
         <div class="form-group col-md-12">
             ...
             <div class="col-md-9">
                 <input  value="{{ $city->name_en.' '.'Egypt' }}"
         ...
         <div class="row">
             <div class="form-group col-md-12">
                 <input type="text" id="mapsearch" value="{{ $city->name_ar.' '.'مصر' }}" size="50" placeholder="ابحث عن موقعك">
                 <div id="map-canvas"></div>
             </div>
         </div>

         <input name="lat" id="latitude" value="{{ old('lat', $city->lat) }}"
                type="hidden"/>
         <input name="lng" id="longitude" value="{{ old('lng', $city->lng) }}"
                type="hidden"/>
         <div style=" clear: both;"></div>
