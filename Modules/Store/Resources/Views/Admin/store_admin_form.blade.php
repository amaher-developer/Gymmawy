...
@section('breadcrumb')
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a href="{{ route('listStore') }}">Stores</a>
             <i class="fa fa-circle"></i>
        </li>
        <li>{{ $title }}</li>
    </ul>
...
@section('page_body')
    ...
    <div class="col-md-9">
        <input id="name" value="{{ old('name', $store->name) }}"
    ...
    <div class="col-md-9">
        <input id="price" value="{{ old('price', $store->price) }}"
    ...
    <div class="col-md-9">
        <input id="description" value="{{ old('description', $store->description) }}"
    ...
    <div class="col-md-9">
        <input id="quantity" value="{{ old('quantity', $store->quantity) }}"
