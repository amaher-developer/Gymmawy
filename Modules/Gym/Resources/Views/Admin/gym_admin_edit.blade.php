            ...
            <div class="card">
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form method="post"
                              action="{{route('uploadAdminGymImages')}}"
        ...
        <div class="form-body">
            ...
            <div class="form-group col-md-12 col-sm-12">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <input id="gym_image" value=""
                           name="image" type="file" class="form-control" >
                    <br/>
                    <label for="gym_image" style="cursor: pointer;">
                        <img id="preview1" src="{{@$gym->image ? @$gym->image : asset('resources/assets/front/img/preview_icon.png')}}"
                ...
                <div class="col-md-3  col-sm-6 ">
                    ...
                    <label for="logo" style="cursor: pointer;">
                        <img id="preview2" src="{{@$gym->gym_brand->logo ? @$gym->gym_brand->logo: asset('resources/assets/front/img/preview_icon.png')}}"
                             style="height: 120px;width: 120px;object-fit: contain;border: 1px solid #c2cad8;"
                             alt="preview image"/>
                    </label>
                </div>
            ...
            <div class="form-group col-md-12 col-sm-12">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <input id="gym_cover_image" value=""
                           name="cover_image" type="file" class="form-control">
                    <br/>
                    <label for="gym_cover_image" style="cursor: pointer;">
                        <img id="preview3" src="{{@$gym->cover_image ? @$gym->cover_image : asset('resources/assets/front/img/preview_icon.png')}}"
            ...
            <div class="form-group col-md-6">
                <label class="col-md-3 control-label text-right">{{trans('admin.gym_name')}} (AR)<span
                            class="required">*</span></label>
                <div class="col-md-9">
                    <input id="name_ar" value="{{ old('name_ar', @$gym->gym_brand->name_ar) }}"
                           name="name_ar" type="text" class="form-control" required>
                </div>
            </div>
            <div class="form-group col-md-6">
                <label class="col-md-3 control-label text-right">{{trans('admin.gym_name')}} (EN)<span
                            class="required">*</span></label>
                <div class="col-md-9">
                    <input id="name_en" value="{{ old('name_en', @$gym->gym_brand->name_en) }}"
            ...
            <div class="form-group col-md-6">
                <label class="col-md-3 control-label text-right">{{trans('admin.about_gym')}} (AR)<span
                            class="required">*</span></label>
                <div class="col-md-9">
                 <textarea id="description_ar"
                           name="description_ar" class="form-control"
                           rows="6">{{ old('description_ar', @$gym->gym_brand->description_ar) }}</textarea>
                </div>
            </div>
            <div class="form-group col-md-6">
                <label class="col-md-3 control-label text-right">{{trans('admin.about_gym')}} (EN)<span
                            class="required">*</span></label>
                <div class="col-md-9">
                 <textarea id="description_en"
                           name="description_en" class="form-control"
                           rows="6">{{ old('description_en', @$gym->gym_brand->description_en) }}</textarea>
                </div>
            </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <label class="mt-checkbox mt-checkbox-outline">
                                            <input type="checkbox" name="categories[]" value="{{$category->id}}" @if(in_array($category->id, $gym_category_ids)) checked @endif
                            ...
                            @foreach($gymservices as $service)
                                <li>
                                    <div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-10">
                                            <label class="mt-checkbox mt-checkbox-outline">
                                                <input type="checkbox" name="services[]" value="{{$service->id}}" @if(in_array($service->id, $gym_service_ids)) checked @endif
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="main_phone" value="{{ old('main_phone', @$gym->gym_brand->main_phone) }}"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="website" value="{{ old('socials[website]', @$gym->gym_brand->socials['website']) }}" dir="ltr"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="facebook" value="{{ old('socials[facebook]', @$gym->gym_brand->socials['facebook']) }}" dir="ltr"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="twitter" value="{{ old('socials[twitter]', @$gym->gym_brand->socials['twitter']) }}" dir="ltr"
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="instagram" value="{{ old('socials[instagram]', @$gym->gym_brand->socials['instagram']) }}" dir="ltr"
                               name="socials[instagram]" type="text" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group col-md-12">
                <label class="col-md-3 control-label text-right">{{trans('admin.snapchat')}}</label>
                <div class="col-md-9">
                    <div class="input-icon">
                        <i class="fa fa-snapchat"></i>
                        <input id="snapchat" value="{{ old('socials[snapchat]', @$gym->gym_brand->socials['snapchat']) }}" dir="ltr"
                               name="socials[snapchat]" type="text" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input id="tags_1" name="phones" type="text" class="form-control tags" value="{{isset($gym->phones) ? implode(',', $gym->phones) : ''}}" placeholder="{{trans('admin.phones')}}"/>
                </div>
            </div>
            ...
            <div class="form-group col-md-6 col-sm-6">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input class="form-control" type="text" name="address" required value="{{ old('address', @$gym->address) }}"
            ...
            <div class="form-group col-md-6 col-sm-6">
                <div class="col-md-6">
                    <div class="input-icon">
                        <i class="fa fa-map-marker"></i>
                        <input class="form-control" type="text" name="address_ar" required value="{{ old('address_ar', @$gym->address_ar) }}"
                               placeholder="{{trans('global.address')}} AR">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="input-icon">
                        <i class="fa fa-map-marker"></i>
                        <input class="form-control" type="text" name="address_en" required value="{{ old('address_en', @$gym->address_en) }}"
                               placeholder="{{trans('global.address')}} EN">
                    </div>
                </div>
            </div>
            <div style="clear: both"></div>
            ...
            <div class="form-group col-md-12" style="clear:both;">
                <label>{{$gym->lat}}, {{$gym->lng}}</label> |
                <label><a href="https://www.google.com/maps/search/{{$gym->lat}},{{$gym->lng}}" target="_blank">go to map</a></label>
            </div>
            @endif
            <div class="form-group col-md-12" style="clear:both;">
                <hr/>
                    ...
                    <div class="mt-checkbox-list">
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input type="checkbox" value="1" name="published"
                                   @if(@$gym->published) checked=""  @endif />
            ...
            <div class="form-group col-md-12" style="clear:both;">
                <label class="col-md-2 control-label" style="padding-top: 14px;">{{trans('admin.featured')}}</label>
                <div class="col-md-10">
                    <div class="mt-checkbox-list">
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input type="checkbox" value="1" name="featured"
                                   @if(@$gym->featured) checked=""  @endif />
                            <span></span>
                        </label>
                    </div>
                </div>
