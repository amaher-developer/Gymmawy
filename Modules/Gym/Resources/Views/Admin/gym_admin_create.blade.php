        ...
        <div class="form-body">
            ...
            <div class="form-group col-md-12 col-sm-12">
                ...
                <div class="col-md-3  col-sm-6 ">
                    ...
                    <label for="logo" style="cursor: pointer;">
                        <img id="preview2" src="{{@$gym->logo ? @$gym->logo: asset('resources/assets/front/img/preview_icon.png')}}"
                             style="height: 120px;width: 120px;object-fit: contain;border: 1px solid #c2cad8;"
                             alt="preview image"/>
                    </label>
                </div>
                            ...
                            @foreach($gymservices as $service)
                                <li>
                                    <div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-10">
                                            <label class="mt-checkbox mt-checkbox-outline">
                                                <input type="checkbox" name="services[]" value="{{$service->id}}" @if(in_array($category->id, $gym_service_ids)) checked @endif
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <div class="input-icon">
                        ...
                        <input id="snapchat" value="{{ old('socials[snapchat]', @$gym->socials['snapchat']) }}" dir="ltr"
            ...
            <div class="form-group col-md-6 col-sm-6">
                <div class="col-md-6">
                    <div class="input-icon">
                        <i class="fa fa-map-marker"></i>
                        <input class="form-control" type="text" name="address_ar" required value="{{ old('address_ar') }}"
                ...
                <div class="col-md-6">
                    <div class="input-icon">
                        <i class="fa fa-map-marker"></i>
                        <input class="form-control" type="text" name="address_en" required value="{{ old('address_en') }}"
                    ...
                    <div class="mt-checkbox-list">
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input type="checkbox" value="1" name="featured"
                                   @if(@$gym->featured) {{ $gym->featured?'checked':'' }} @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
