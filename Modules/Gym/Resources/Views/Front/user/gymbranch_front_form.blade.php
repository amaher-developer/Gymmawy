...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}resources/assets/admin/global/css/file-uploaders/dropzone.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}resources/assets/admin/global/css/vendors/file-uploaders/dropzone.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}resources/assets/admin/global/css/cropper/cropper.min.css">
        ...
        <div class="form-body">
            ...
            <div class="form-group col-md-12 col-sm-12">
                ...
                <div class="col-md-3 col-sm-6 ">
                    <input id="gym_image"
                           name="image" type="file" class="form-control"  @if(!$gym->image) required @endif>
                    <br/>
                    <label for="gym_image" style="cursor: pointer;">
                        <img id="preview1"
                             src="@if(@$gym->image) {{$gym->image}} @else {{asset('resources/assets/front/img/preview_icon.png')}} @endif"
                             style="height: 120px;width: 100%;object-fit: contain;border: 1px solid #c2cad8;"
                             alt="preview image"/>
                    </label>
                </div>
                ...
                <div class="col-md-3 col-sm-6 ">
                    <input id="gym_cover_image"
                           name="cover_image" type="file" class="form-control">
                    <br/>
                    <label for="gym_cover_image" style="cursor: pointer;">
                        <img id="preview3"
                             src="@if(@$gym->cover_image) {{$gym->cover_image}} @else {{asset('resources/assets/front/img/preview_icon.png')}} @endif"
                             style="height: 120px;width: 100%;object-fit: contain;border: 1px solid #c2cad8;object-fit: cover"
                             alt="preview image"/>
                    </label>
                </div>
            </div>
                                    ...
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <label class="mt-checkbox mt-checkbox-outline">
                                            <input type="checkbox" name="categories[]" value="{{$category->id}}"
                                                   @if(in_array($category->id, $gym_category_ids)) checked @endif
                                        ...
                                        <div class="col-sm-offset-1 col-sm-10">
                                            <label class="mt-checkbox mt-checkbox-outline">
                                                <input type="checkbox" name="services[]" value="{{$service->id}}"
                                                       @if(in_array($service->id, $gym_service_ids)) checked @endif
            ...
            <div class="form-group col-md-12">
                <label class="control-label col-md-3">{{trans('admin.other_phones')}} <span
                            class="required">*</span></label>
                <div class="col-md-9">
                    <input id="tags_1" name="phones" type="text" required class="form-control tags"
                           value="{{isset($gym->phones) ? implode(',', $gym->phones) : ''}}"
                           placeholder="{{trans('admin.phones')}}"/>
                </div>
            </div>
...
@section('sub_scripts')
    ...
    <script src="{{asset('/')}}resources/assets/admin/global/scripts/dropzone.min.js" type="text/javascript"></script>
    <script src="https://unpkg.com/dropzone@5.7.0/dist/dropzone.js" type="text/javascript"></script>
    <script src="https://unpkg.com/cropperjs@1.5.6/dist/cropper.js" type="text/javascript"></script>
