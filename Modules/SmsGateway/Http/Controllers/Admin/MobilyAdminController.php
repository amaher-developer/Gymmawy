...
class MobilyAdminController extends GenericAdminController
{

    public static function sentSms($to = null, $content = 'hello', $apiKey = 'ea3fac3848fc63115ae95be5953ea1b7'){
        $to = request('to');
        $content = request('msg');
        if($to && $content) {
