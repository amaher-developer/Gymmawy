...
class ClickatellAdminController extends GenericAdminController
{
    public $gateway = 'http://api.smsala.com/';
    public $password = 'sZf7yzz5U3';
    public $username = 'SAU73396814843';
    public $sender = 'Yacune';
    public $apiKey = 'API73383465094';


    public function sentSms($to = null, $content = 'hello', $apiKey){
        $apiKey = $this->apiKey;
        ...
        if($to && $content) {
                ...
                $to = ltrim($to, 0);
                $url = $this->gateway.'api/SendSMS?api_id=' . $apiKey . '&api_password='.$password.'&sms_type=T&encoding=U&sender_id='.$sender.'&phonenumber='.$to.'&textmessage=' .  urlencode($content) ;
