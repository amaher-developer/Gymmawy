...
{{--                    <h4 class="nomargin_top" style="padding-bottom: 20px">{{$title}}</h4>--}}
                    ...
                    <div class="box_detail booking" style="background-color: white">
                        <div class="price">
                            <h5 class="d-inline">{{trans('global.calculate_ibw')}}</h5>
{{--                                                        <div class="score"><span>Good<em>350 Reviews</em></span><strong>7.0</strong></div>--}}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" value="180" name="ibw_height" id="ibw_height" class="form-control" required>
                                </div>
                                <div class="form-group col-md-12 add_top_20">
                                    <button class=" btn_1 " onclick="submit_calculate_ibw()"
                                            id="submit_calculate_ibw">{{trans('global.calculate')}}</button>
                                </div>
                            </div>
